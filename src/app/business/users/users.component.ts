...
export class UsersComponent {
  ...
  */
  ...
  getAllUsers() {
    this.httpDataService.getUsers().subscribe((response: any) => {
...
/**/
  ...
  //add
  addUser(){ 
    this.userData.Usuario_ID = this.dataSource.data.length + 1; //this.dataSource.data.length + 1;
  ...
  //update
  updateUser(){
    this.httpDataService.updateUser(this.userData.Usuario_ID, this.userData).subscribe((response: any)=>{
      this.dataSource.data = this.dataSource.data.map((o: any)=>{
